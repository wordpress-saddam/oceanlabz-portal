...
export default function EditDevicePage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // Fetch device and users in parallel
                const [deviceResponse, usersResponse] = await Promise.all([
                    locationDeviceApi.getById(deviceId, token),
                ...
                if (deviceResponse.success && deviceResponse.data.device) {
                    ...
                    setFormData({
                        ...
                        user_id: device.user_id ? device.user_id.toString() : "",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await locationDeviceApi.update(deviceId, {
                name: formData.name,
                type: formData.type,
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-96">
                <div className="text-white text-lg">Loading device data...</div>
            </div>
        );
    }
        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-[#9a9a9a] text-sm">Update device information</p>
                </div>
                <Link
